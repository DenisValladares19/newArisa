...
// Page header
    function Header()
    {
        ...
        $this->Cell(40,5,'Fecha',1,0,'C',true);
        $this->Ln();
...
$fechaF = $fechaFP;
$fechaL = $fechaIP;
$query = mysqli_query($con, "select o.*, c.idCotizacion, cl.nombre, cl.apellido,e.nombre as ne from orden o inner join cotizacion c on o.idCotizacion = c.idCotizacion inner join cliente cl on c.idCliente = cl.idCliente inner join estado2 e on o.idEstado2 = e.idEstado2 where o.fecha between '$fechaF' and '$fechaL' and o.borradoLogico!=0" );
